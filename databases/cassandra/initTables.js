const tables = {
  ...
  styles:
    'CREATE TABLE IF NOT EXISTS styles (product_id TEXT,style_id INT , name TEXT, original_price TEXT, sale_price TEXT, default_style INT, PRIMARY KEY(product_id, style_id))',
  related:
  ...
  skus: 'CREATE TABLE IF NOT EXISTS skus (style_id INT PRIMARY KEY, skus skus)',
};
